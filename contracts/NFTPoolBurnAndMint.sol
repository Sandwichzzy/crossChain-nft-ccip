...
contract NFTPoolBurnAndMint is CCIPReceiver, OwnerIsCreator {
    ...
    constructor(address _router, address _link, address _wnftAddr) CCIPReceiver(_router) {
        s_linkToken = IERC20(_link);
        wnft=WrappedMyToken(_wnftAddr);
    }
    ...
    function burnAndSendNFT(uint256 tokenID, address newOwner,uint64 chainSelector, address receiver) public returns (bytes32 messageId){
        //transfer the wnft to this address
    ...
    function _ccipReceive(
        ...
        override
    {
        //address new Owner, uint256 tokenID
