...
contract NFTPoolLockAndRelease is CCIPReceiver, OwnerIsCreator {
        ...
        override
    {
        ...
        //check if the nft is locked(no need) ERC721 transferFrom will revert if the nft is not in address(this)
        //transfer token from this address to the new owner 
    ...
    function _buildCCIPMessage(
        ...
        return
            Client.EVM2AnyMessage({
                ...
                data: _data, // The data to be sent
